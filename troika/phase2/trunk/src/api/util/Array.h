...
/** Constructor. */
extern Array *array__new( int buffer_size, unsigned int expansion );

/** Copy constructor. */
extern Array *array__copy( Array *a );

/** Destructor. */
extern void array__delete( Array *a );


/******************************************************************************/

extern int array__size( Array *a );

extern unsigned int array__expansion( Array *a );


/* Random access **************************************************************/

/** Gets the array item at a given index. */
extern void *array__get( Array *a, int i );

/** Sets the array item at a given index. */
extern void *array__set( Array *a, int i, void *p );


/* Stack and queue operations *************************************************/

/** Gets the first item in the array without removing it. */
extern void *array__peek( Array *a );

/** Pushes an item onto the front of the array (as a stack). */
extern void *array__push( Array *a, void *p );

/** Removes the item at the front of the array (as a stack). */
extern void *array__pop( Array *a );

/** Adds an item to the tail end of the array (as a queue). */
extern void *array__enqueue( Array *a, void *p );

/** Removes an item from the tail end of the array (as a queue).
    \warning this usage is nonstandard */
extern void *array__dequeue( Array *a );
...
extern void *array__insert_before( Array *a, int i, void *p );

/** Insert an item after the given index.
    \warning O(n) memory copying overhead */
extern void *array__insert_after( Array *a, int i, void *p );

/** Remove the item at the given index.
    \warning O(n) memory copying overhead */
extern void *array__remove( Array *a, int i );
...
/** Removes an array item and replaces it with the last item in the array,
    ...
    important. */
extern void *array__simple_remove( Array *a, int i );


/* Array sorting **************************************************************/

/** Sorts the array using MergeSort. */
extern void array__sort( Array *a, comparator compare );


/* Logical set functions and item substitution ********************************/


extern void array__distribute( Array *a, p2_procedure *p );


/* Miscellaneous **************************************************************/

/** Empties the array. */
extern Array *array__clear( Array *a );
...
/** Resizes the array to occupy as little memory as possible.
    ...
    maximum. */
extern Array *array__minimize( Array *a );


/******************************************************************************/

extern Type *array__type( const char *name, int flags );
