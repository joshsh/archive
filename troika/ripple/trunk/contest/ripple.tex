...
\title{Ripple RDF Scripting Language: Linked Data as Linked Programs}

Introducing Ripple: Linked Data as Programs

Linked Data as Programs: Introducing Ripple


Ripple: Linked Data as Programs




% a short form should be given in case it is too long for the running head
\titlerunning{Ripple -- a Semantic Web Scripting Language}
...
Contact Volume Editor which of your names is/are your first name(s) and
...
by courier. One author may sign on behalf of all the other authors of a particular
