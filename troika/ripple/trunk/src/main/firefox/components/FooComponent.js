...
var FooModule = {
    ...
    _myFactory : {
        createInstance : function(outer, iid) {
            ...
            if (!(instance)) {
                instance = new FooComponent(); // FooComponent is declared below
            }
 ...
 */
FooComponent.prototype.QueryInterface = function(iid) {
    /*
 ...
 */
FooComponent.prototype.initialize = function (java, trace) {
...
FooComponent.prototype._bootstrapClassLoader = function(java, extensionPath) {
    if (this._bootstraped) {
        return;
    }
    
    this._trace("FooComponent._bootstrapClassLoader {");
...
FooComponent.prototype._loadJava = function(java, jarURLStrings) {
    this._trace("FooComponent._loadJava {");
