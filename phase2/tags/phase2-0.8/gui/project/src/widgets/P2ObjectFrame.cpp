...
P2ObjectFrame::P2ObjectFrame( const Object *o, QString title, P2Binder &b, bool initiallyExpanded )
    : P2Widget(),
      constObject( o )
{
    binder = &b;
...
void P2ObjectFrame::expand()
{
    ...
    if ( !contentWidget )
    {
        ...
        connect(    contentWidget,  SIGNAL( resized() ),
                    this,           SLOT(   update() ) );
    }
